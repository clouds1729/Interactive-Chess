/*
 * An Interactive Chess Tool heavily inspired by works from Zeyu Zhang
...
function startSpeechRecognition() {
  ...
  // Notify the user that speech recognition is active
  ...
  recognition.onresult = function (event) {
    ...
    document.getElementById("userInput").value = speechText; // Fill input box
    askAI(); // Automatically send the input
  };

  recognition.onerror = function (event) {
    console.error("Speech recognition error:", event.error);
    document.getElementById("aiResponse").innerText = "Speech recognition failed. Try again.";
  };
}
